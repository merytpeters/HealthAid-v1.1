...
def upgrade() -> None:
    ...
    op.create_foreign_key('users_assigned_staff_id_fkey', 'users', 'org_members', ['assigned_staff_id'], ['id'])
    op.create_foreign_key('users_organization_id_fkey', 'users', 'organizations', ['organization_id'], ['id'])
    op.create_foreign_key('org_members_user_id_fkey', 'org_members', 'users', ['user_id'], ['id'])
    op.create_foreign_key('org_members_organization_id_fkey', 'org_members', 'organizations', ['organization_id'], ['id'])
