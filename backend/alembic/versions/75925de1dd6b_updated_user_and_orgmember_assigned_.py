...
def upgrade() -> None:
    ...
    op.drop_constraint(
        "users_organization_id_fkey", "users", type_="foreignkey"
    )  # ✅ ADD THIS
    ...
    op.execute(
        "ALTER TABLE organizations ALTER COLUMN id TYPE INTEGER USING id::integer"
    )
    op.alter_column(
        "organizations",
        "id",
    ...
    op.execute(
        "ALTER TABLE users ALTER COLUMN organization_id TYPE INTEGER USING organization_id::integer"
    )
    op.alter_column(
        "users",
        "organization_id",
    ...
    op.execute(
        "ALTER TABLE users ALTER COLUMN assigned_staff_id TYPE INTEGER USING assigned_staff_id::integer"
    )
    op.alter_column(
        "users",
        "assigned_staff_id",
    ...
    op.execute(
        "ALTER TABLE org_members ALTER COLUMN user_id TYPE INTEGER USING user_id::integer"
    )
    op.alter_column(
        "org_members",
        "user_id",
    ...
    op.execute(
        "ALTER TABLE org_members ALTER COLUMN organization_id TYPE INTEGER USING organization_id::integer"
    )
    op.alter_column(
        "org_members",
        "organization_id",
